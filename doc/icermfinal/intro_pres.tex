...
\centering
\includegraphics[width=4.5in]{./fig/hubness_def_1.png}
...
\centering
\includegraphics[width=4.5in]{./fig/hubness_def_2.png}
...
\centering
\includegraphics[width=4.5in]{./fig/gaussian_illustration.png}
\end{frame}

\begin{frame}
\frametitle{Synthetic data -- dimensionality difference}
\centering
\includegraphics[width=4.5in]{./fig/priya_illustration.png}
\end{frame}

\begin{frame}
\frametitle{Real-world data: spam classification}
\centering
\includegraphics[width=4.5in]{./fig/spam_illustration.png}
\end{frame}
